package com.visioncameraachrafaslrecognizer;
...
public class VisionCameraAchrafAslRecognizerPackage implements ReactPackage {
  @NonNull
  ...
  public List<NativeModule> createNativeModules(@NonNull @org.jetbrains.annotations.NotNull ReactApplicationContext reactContext) {
    FrameProcessorPlugin.register(new VisionCameraAchrafAslRecognizerPlugin());
